...
// myarr.unshift(8) //inseert the element to the begining
// console.log(myarr); 
...
console.log(myn1);  //the values after using slace method
...
console.log(myn2); //from array the splice o/p get removed splice o/p :[4,5,6] after splice o/p : [3,7]
